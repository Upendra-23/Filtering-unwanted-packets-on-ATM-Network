...
public class Forwarding {
	...
	Forwarding() {
		try {
			...
			JOptionPane.showMessageDialog((Component) null, "There Is No Message To Forward", "Click OK",
	...
	public boolean Forward() {
		...
		while (e.hasMoreElements()) {
			...
			try {
				...
				JOptionPane.showMessageDialog((Component) null, dest + " Is Not Connected", "Click OK",
						JOptionPane.INFORMATION_MESSAGE);
		...
		if (c == 0) {
			...
			JOptionPane.showMessageDialog((Component) null,
					"Packets are Sucessfully Forwarded from Bridge to Destination", "Click OK",
					JOptionPane.INFORMATION_MESSAGE);
