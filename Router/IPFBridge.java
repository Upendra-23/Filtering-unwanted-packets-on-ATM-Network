			...
			switch (count) {
				...
				case 3:
					...
					try {
						...
						JOptionPane.showMessageDialog((Component) null, "There Is No Message To Learn", "Click OK",
				...
				case 4:
					...
					break;
				default:
					JOptionPane.showMessageDialog((Component) null, "Type Only Numbers Between or equal to 1 & 4",
...
class Login implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == submit) {
			...
			if ((((txtuser.getText()).trim()).equalsIgnoreCase("admin")) && ((pass.trim()).equalsIgnoreCase("admin"))) {
				jf.setVisible(false);
				ch = true;
			} else {
				JOptionPane.showMessageDialog((Component) null, "User Name & Password Is Invalid", "Click OK",
						JOptionPane.INFORMATION_MESSAGE);
				ch = false;
			}
		} else {
			...
			while (c.ch) {
				try {
					...
					while (true) {
						...
						Receiver g1 = new Receiver(insocket1);
					}
